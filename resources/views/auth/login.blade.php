                ...
                <div class="col-lg-5  col-md-8  col-sm-12 mx-auto">
                    <div class="login_logo login_border_radius1">
                        <h3 class="text-center">
                            <!-- <img src="{{asset('img/logo.png')}}" alt="josh logo" class="admire_logo" style="width: auto; height: 49px;"> -->
                        ...
                        <form  action="{{ route('login') }}" id="login_validator" method="post" class="login_validator">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-prepend">
                                    ...
                                    <input type="email" class="form-control  form-control-md" id="email" name="email" value="{{ old('email') }}" placeholder="E-mail" required autocomplete="email" autofocus>
                                    @error('email')
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-prepend">
                                    ...
                                    <input type="password" class="form-control form-control-md" id="password"   name="password" placeholder="Password" required autocomplete="current-password">
                                    @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
