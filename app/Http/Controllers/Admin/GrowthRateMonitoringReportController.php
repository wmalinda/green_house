...
class GrowthRateMonitoringReportController extends Controller
{
    ...
    //dd('sdsd');
        $data['slug'] = 'Growth Rate Monitoring Report';
        $data['title'] = 'Growth Rate Monitoring Report';
        $data['sub_page'] = 'Growth Rate Monitoring Report';
        $data['page_title'] = 'Growth Rate Monitoring Report';
